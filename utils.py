...
def main():
    file_path = "./uploads/fake_sku_wo_data_v2.xlsx"
    year, month, year1, month1 = 2023, 8, 2024, 8
    ...
    print("Report generated successfully.",final)
    # You can print or save the report as needed
